...
const scheduleItems: ScheduleItem[] = [
  {
    ...
    location: 'Home',
    locationLink: 'https://maps.app.goo.gl/kvMxxXcudjwUeo5W6',
    icon: <Sun size={20} />,
  ...
  },
  {
    ...
    location: 'Gurudwara Shri Guru Singh Sabha',
    locationLink: 'https://maps.app.goo.gl/7MRJLS1daoosiKF98',
    icon: <Church size={20} />,
  ...
  },
  {
    ...
    location: 'Agarwal',
    locationLink: 'https://maps.app.goo.gl/5bDT8j8zLt5ufskM6',
    icon: <Users size={20} />,
