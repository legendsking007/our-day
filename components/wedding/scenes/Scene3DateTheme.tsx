      ...
      <div className="flex flex-col items-center justify-center h-full px-8 text-center relative z-10">
        ...
        >
          ...
          >
            ...
            <h2 className="text-2xl font-script text-gray-700 mb-2">
          ...
          >
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-dusty-blue/20">
              ...
              <div className="text-6xl font-serif font-bold text-gray-800 mb-2">
                06
              </div>
              <h2 className="text-2xl font-serif text-gray-700 mb-1">
                December
              </h2>
              <div className="text-3xl font-serif font-medium text-dusty-blue">
                2025
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-lg font-script text-dusty-blue mb-2">
                Dusty Blue & White
              </p>
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <span className="text-xs font-serif text-gray-600 mt-2">Dusty Blue</span>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 rounded-full bg-white shadow-lg border-2 border-dusty-blue/30" />
                <span className="text-xs font-serif text-gray-600 mt-2">Pure White</span>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 rounded-full bg-silver shadow-lg border-2 border-white" />
                <span className="text-xs font-serif text-gray-600 mt-2">Silver</span>
              </div>
            </motion.div>
          </motion.div>
        </motion.div>
